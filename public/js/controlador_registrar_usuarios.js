...
const input_password = document.querySelector('#txt_password');
const boton_registrar = document.querySelector('#btn_registrar');
const input_tipo1 = document.querySelector('#slt_tipo1');
...
let obtener_datos = () => {
    ...
    if (validar() == false) {
        ...
        let tipo = slt_tipo1.value;
        let foto = input_foto.value;

        

        registrar_usuario(nombre, identificacion, nacionalidad, provincias, cantones,distritos, hijos, correo, password,tipo, foto);
